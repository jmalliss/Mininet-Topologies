...
class LinearTopo( Topo ):
	"LinearTopology ;4 switches and 4 hosts"
	...
	def build( self ):
		...
		self.addLink(s3,s4,cls=TCLink,bw=20)
		self.addLink(s1,h1,cls=TCLink,bw=20)
		self.addLink(s2,h2,cls=TCLink,bw=20)
		self.addLink(s3,h3,cls=TCLink,bw=20)
		self.addLink(s4,h4,cls=TCLink,bw=20)

def runLinear():
	"Bootstrap a Mininet network using the Linear Topology"
